...
targetBtn.MouseButton1Click:Connect(function()
	...
	if not TARGET_ON and TargetHighlight then
...
--------------------------------------------------
-- TARGET VISUAL (INIMIGO MAIS PRÓXIMO)
--------------------------------------------------
...
RunService.RenderStepped:Connect(function()
	...
	for player, data in pairs(ESP) do
		...
		if hrp then
			...
			-- Target visual (somente inimigos)
			if TARGET_ON and player.Team ~= LocalPlayer.Team then
